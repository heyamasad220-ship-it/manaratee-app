...
export const PERMISSION_DEFINITIONS: PermissionDefinition[] = [
  ...
  },
  {
    ...
    description: "Full Fund Development access: ledger, settings, campaigns, prospects, and reports ops.",
    group: "Donations",
    moduleSlugs: ["donations"],
  },
  {
    key: "donations.campaigns.manage",
    label: "Manage Campaigns",
    description: "Can create and edit campaigns, phases, ask levels, and campaign groups (not full ledger admin).",
    group: "Donations",
    moduleSlugs: ["donations"],
  },
  {
    key: "donations.prospects.manage",
    label: "Manage Prospects",
    description: "Can add, assign, update, and convert campaign prospects to pledges.",
    group: "Donations",
    moduleSlugs: ["donations"],
  },
  {
    key: "donations.reports.manage",
    label: "Manage Donation Reports Ops",
    description: "Can run import and payment match tools without full donations manage access.",
    group: "Donations",
    moduleSlugs: ["donations"],
  },
  {
