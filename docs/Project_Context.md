...
**Canonical Pledge Details window (August 2026)** — Staff add/edit/collect/remind/delete pledges from one dialog (`components/donations/pledge-details-dialog.tsx`) on Pledges, campaign workspace, prospects, and contact Financial. Missing contacts can be created from Contact search (person or organization). Customer portal unchanged.
