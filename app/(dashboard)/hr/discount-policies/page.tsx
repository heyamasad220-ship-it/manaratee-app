          ...
          <CardContent className="flex items-start gap-3 p-4">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">
                Discount tags identify customer groups such as staff, members,
                volunteers, board members, or scholarship recipients. Later,
                program discount rules can use these tags to automatically apply
                the correct discount at checkout.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <Card className="lg:col-span-2">
            <CardHeader>
              ...
              <CardDescription>
                Manage the customer tags that discount policies can use.
              </CardDescription>
            </CardHeader>
              ...
              {tags.length === 0 ? (
                <div className="flex min-h-[260px] flex-col items-center justify-center p-8 text-center">
                  ...
                  <p className="mt-2 max-w-md text-sm text-muted-foreground">
                    Create tags like Staff, Member, Volunteer, Board Member, or
                    Scholarship Recipient. These will become the foundation for
                    automatic discounts.
                  </p>
                </div>
              ) : (
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Add a customer group that can receive discounts later.
              </CardDescription>
            </CardHeader>
