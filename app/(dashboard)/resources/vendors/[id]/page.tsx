...
const mockVendor: Vendor = {
  ...
  previousEvents: [
    { eventName: "Eid Bazaar 2025", date: "Apr 10, 2025", boothType: "Standard", boothNumber: "B-05", amountPaid: 350, performance: "Excellent", notes: "Great customer feedback. Very organized and professional. High sales volume." },
    { eventName: "Community Festival 2024", date: "Sep 15, 2024", boothType: "Standard", boothNumber: "C-12", amountPaid: 300, performance: "Good", notes: "Arrived on time. Good presentation. Minor issue with signage resolved quickly." },
    { eventName: "Ramadan Night Market 2024", date: "Mar 20, 2024", boothType: "Premium", boothNumber: "A-03", amountPaid: 400, performance: "Excellent", notes: "Exceptional quality products. Many repeat customers asked about them." },
  ],
}
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                <Card>
                  <CardContent className="p-4">
                    ...
                    <p className="text-2xl font-bold">{vendor.previousEvents.length}</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-4">
                    <p className="text-sm text-muted-foreground">Total Paid (Historical)</p>
                    <p className="text-2xl font-bold text-emerald-600">
                      {formatCurrency(vendor.previousEvents.reduce((sum, e) => sum + e.amountPaid, 0))}
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="p-4">
                    ...
                    <p className="text-2xl font-bold text-primary">
                      {vendor.previousEvents.length > 0 
                        ? (vendor.previousEvents.filter(e => e.performance === "Excellent" || e.performance === "Good").length / vendor.previousEvents.length * 100).toFixed(0) + "% Positive"
                        : "N/A"}
                    </p>
                  </CardContent>
                </Card>
                          ...
                          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                            <div className="flex flex-col gap-1">
                              <div className="flex items-center gap-2">
                                ...
                                <Badge 
                                  variant="secondary" 
                                  className={
                                    event.performance === "Excellent" ? "bg-emerald-100 text-emerald-700" :
                                    event.performance === "Good" ? "bg-blue-100 text-blue-700" :
                                    event.performance === "Average" ? "bg-amber-100 text-amber-700" :
                                    "bg-red-100 text-red-700"
                                  }
                                >
                                  {event.performance}
                            ...
                            <div className="flex items-center gap-4 text-sm">
                              <div className="text-right">
                                ...
                                <p className="font-medium">{event.boothNumber}</p>
                              </div>
                              <div className="text-right">
                              ...
                              <div className="text-right">
                                ...
                                <p className="font-medium text-emerald-600">{formatCurrency(event.amountPaid)}</p>
                              </div>
                            </div>
                          </div>
                          {event.notes && (
