...
import { Heart, CreditCard, DollarSign, Calendar, ChevronRight, Plus, ArrowUpRight, CheckCircle2, Clock, AlertCircle } from "lucide-react"
...
const pledges = [
  ...
  {
    id: "pl-3",
    campaign: "Ramadan Campaign 2023",
    totalAmount: 600,
    paidAmount: 600,
    balance: 0,
    frequency: "One-time",
...
const savedPaymentMethods = [
  ...
  { id: "pm-2", type: "Mastercard", last4: "5555", isDefault: false },
]
...
export default function DonorGivingPage() {
  const [selectedPledge, setSelectedPledge] = useState<typeof pledges[0] | null>(null)
  ...
  const handlePayPledge = (pledge: typeof pledges[0]) => {
    setSelectedPledge(pledge)
    setPaymentAmount(pledge.nextPaymentAmount.toString())
  ...
  const upcomingPaymentTotal = activePledges.reduce((sum, p) => sum + p.nextPaymentAmount, 0)

  return (
    <div className="flex flex-col gap-8">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-foreground">My Giving</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          View your pledges, payments, and manage your giving.
        </p>
      </div>
          ...
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-foreground">{formatCurrency(donorData.totalPledged)}</p>
              </div>
          ...
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-emerald-600">{formatCurrency(donorData.totalPaid)}</p>
              </div>
          ...
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-amber-600">{formatCurrency(donorData.outstandingBalance)}</p>
              </div>
          ...
          <CardContent className="p-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-violet-600">{formatCurrency(upcomingPaymentTotal)}</p>
                <p className="text-xs text-muted-foreground mt-1">Apr 1, 2026</p>
              </div>
                    ...
                    <div className="flex flex-col lg:flex-row">
                      ...
                      <div className="flex-1 p-5">
                        ...
                        <div className="mt-4">
                          ...
                          <Progress 
                            value={(pledge.paidAmount / pledge.totalAmount) * 100} 
                            className="h-2"
                          />
                          <div className="flex justify-between text-xs text-muted-foreground mt-1">
                            <span>{Math.round((pledge.paidAmount / pledge.totalAmount) * 100)}% complete</span>
                      ...
                      {pledge.status === "Active" && (
                        <div className="flex flex-col justify-center gap-3 border-t lg:border-t-0 lg:border-l border-border bg-muted/30 p-5 lg:w-64">
                      ...
                      {pledge.status === "Fulfilled" && (
                        <div className="flex flex-col items-center justify-center gap-2 border-t lg:border-t-0 lg:border-l border-border bg-emerald-50 p-5 lg:w-64">
        ...
        <DialogContent className="max-w-md">
          ...
          {paymentSuccess ? (
            <div className="flex flex-col items-center gap-4 py-6">
              ...
              <Button className="w-full mt-4" onClick={() => setShowPaymentDialog(false)}>
                Done
              </Button>
            </div>
          ) : (
                  ...
                  {selectedPledge && (
                    <div className="flex gap-2">
                      <Button
                        ...
                        variant="outline"
                        size="sm"
                        onClick={() => setPaymentAmount(selectedPledge.nextPaymentAmount.toString())}
                      >
                      ...
                      <Button
                        ...
                        variant="outline"
                        size="sm"
                        onClick={() => setPaymentAmount(selectedPledge.balance.toString())}
                      >
      ...
      <Dialog open={showNewPledgeDialog} onOpenChange={setShowNewPledgeDialog}>
        <DialogContent className="max-w-md">
          ...
          <div className="flex flex-col gap-4 py-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Select 
                ...
                onValueChange={(v) => setNewPledgeForm({ ...newPledgeForm, category: v, subcategory: "" })}
              >
                <SelectTrigger>
                ...
                <div className="mt-2 flex justify-between text-sm">
                  ...
                  <span className="font-bold text-foreground">
                    {formatCurrency(
                      ...
                      (newPledgeForm.frequency === "one-time" ? 1 : Number(newPledgeForm.payments))
                    )}
                  </span>
                </div>
              </div>
          ...
          <DialogFooter>
            ...
            <Button onClick={() => setShowNewPledgeDialog(false)}>
              Create Pledge
            </Button>
          </DialogFooter>
        </DialogContent>
