...
import { VolunteerApplyClient } from "@/components/customer/volunteer-apply-client"
...
export default async function CustomerVolunteerApplyPage() {
      ...
      <div className="mx-auto max-w-3xl space-y-4 p-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Sign in to your community account to apply as a volunteer.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild>
      ...
      <div className="mx-auto max-w-3xl space-y-4 p-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Join or select an organization before submitting a volunteer application.
            </CardDescription>
          </CardHeader>
        </Card>
      </div>
      ...
      <div className="mx-auto max-w-3xl space-y-4 p-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Your account needs a linked contact before you can submit a volunteer application.
  ...
  const existingApplications = (await fetchContactApplications(contact.id)).filter(
    (app) => app.application_type === "volunteer"
  )
