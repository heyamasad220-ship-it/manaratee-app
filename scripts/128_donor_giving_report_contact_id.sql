-- Add contact_id to donor giving report RPC rows (for canonical contact profile links)
-- Run after 127_donor_giving_report.sql
--
...
COMMENT ON FUNCTION public.donation_donor_giving_report IS
  'Paginated donor giving report. Includes contact_id for canonical /contacts/[id] links.';
