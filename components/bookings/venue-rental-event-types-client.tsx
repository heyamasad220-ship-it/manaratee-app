...
export function VenueRentalEventTypesClient({
  ...
  function openEdit(eventType: VenueRentalEventType) {
    setForm({
      id: eventType.id,
      name: eventType.name,
  ...
  function handleDelete(eventType: VenueRentalEventType) {
    ...
    startTransition(async () => {
      try {
        await deleteVenueRentalEventType(eventType.id)
      } catch (deleteError) {
        window.alert(
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-6 p-6">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Configure the event types customers can choose when booking a venue.
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Venue rental event types</CardTitle>
            <CardDescription>
              Active types appear on customer booking forms. Inactive types are hidden
              from new requests but remain on existing bookings.
            </CardDescription>
          </CardHeader>
                ...
                {eventTypes.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={4} className="h-24 text-center text-muted-foreground">
                      No event types yet. Add your first type to get started.
                    </TableCell>
                  </TableRow>
                ) : (
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between rounded-md border p-3">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Inactive types are hidden on customer booking forms.
                </p>
              </div>
              <Switch
