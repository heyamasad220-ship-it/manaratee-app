...
import type { ChildcareApplicationData } from "@/lib/mock-data"

export function ChildcareProviderApplyClient({
  applicantName,
  applicantEmail,
  applicantPhone,
  applicantAddress,
  ...
  async function handleSubmit(data: ChildcareApplicationData) {
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Thanks — your childcare provider application is under review. You can track it from
            your profile.
          </CardDescription>
        </CardHeader>
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Childcare Provider Application</h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Share your experience, certifications, and availability. Staff will review your
            application before adding you to the provider roster.
          </p>
        </div>
      </div>
      ...
      {existingApplications.length > 0 ? (
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Your childcare applications</CardTitle>
            <CardDescription>
              {blockingApplications.length > 0
