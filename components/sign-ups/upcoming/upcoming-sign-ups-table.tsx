...
export function UpcomingSignUpsTable() {
  const [search, setSearch] = useState("")

  const filtered = upcomingSignUps.filter(
    (s) =>
  ...
  return (
    <div className="flex flex-col gap-4 p-6">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-semibold text-foreground">Upcoming Sign-Ups</h2>
      ...
      <div className="flex items-center gap-3">
        ...
        <Button className="ml-auto gap-1.5">+ New Sign-Up</Button>
      </div>
